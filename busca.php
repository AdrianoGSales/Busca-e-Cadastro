...
$connect = new PDO("mysql:host=localhost;dbname=id20420987_telainicial", "id20420987_driks", "g~&Ky2m@92#*]1W9");
//o script estabelece uma conexão com o banco de dados MySQL usando a classe PDO (PHP Data Objects).
